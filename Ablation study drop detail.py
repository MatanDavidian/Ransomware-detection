...
c = ["Process Name", "Operation", "Duration", "Result", "Detail" ]  + ["malicious"] # + details
# benign processes
...
file_name = r"predictions/" + f"Ablation study_y_test, droped: detail.txt"
...
for m in all_models:
    ...
    for _ in range(num_of_repeat_same_model):
        ...
        print(f"droped: detail, Accuracy: {accuracy * 100}, fit_time={fit_time},evaluate_time={evaluate_time}\n")
        f.write(f"droped: detail, Accuracy: {accuracy}, fit_time={fit_time},evaluate_time={evaluate_time}\n")
        ...
        f.write(str((fn, tp))+ "\n")
        f.close()
        file_name = r"predictions/" + f"prediction, droped: detail.txt"
